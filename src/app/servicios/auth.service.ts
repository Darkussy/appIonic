...
//imortamos un modelo interface para el usuario que llamara la base de datos 
interface User {
  username: string;
  password: string;
...
export class AuthService {
  ...
  iniciarSesion() {
    ...
    // Por ejemplo, verificar un token o credenciales.
    // Si la autenticación es exitosa, establece usuarioAutenticado en true.
  ...
  cerrarSesion() {
    ...
    // Por ejemplo, eliminar el token o las credenciales.
    // Luego, establece usuarioAutenticado en false.
